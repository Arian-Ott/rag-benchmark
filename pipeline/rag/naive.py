...
from openai import AzureOpenAI  # Assuming you're using
...
class NaiveRagGPT4:
    def __init__(self, embedding_model="text-embedding-ada-002-sweden",
                 gpt_model="gpt-4o"):
        ...
        self.router.add_api_route("/rag/query", self.query, methods=["POST"], tags=["NaiveRag"])
    ...
    def retrieve_documents(self, query_embedding: List[float], top_k: int =
    5) -> List[models.ScoredPoint]:
...
# Example of initializing and using the NaiveRagGPT4 class
# This should be part of your FastAPI application

# Create an instance of the API
naive_rag_gpt4 = NaiveRagGPT4()

# To add the router to a FastAPI app:
# app = FastAPI()
# app.include_router(naive_rag_gpt4.router)
